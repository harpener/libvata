...
int main()
{
	...
	aut.AddTransition("000X", "100X", "100X");
	aut.AddTransition("000X", "010X", "010X");
	aut.AddTransition("100X", "110X", "110X");
	aut.AddTransition("100X", "001X", "001X");

	aut.AddInitialState("000X");

	aut.AddFinalState("100X");
	aut.AddFinalState("010X");
	aut.AddFinalState("001X");
